                                 ...
                                 TString tags = "")
{
    ...
    //'UL2016_postVFP': 16.8,
        ...
        else
        {
            ...
            {
                //ee
                std::cout << "EE channel " <<i<<":"+samples_ee_UL2016postVFP_FR[i]<<std::endl;
                TFile * file_ee = new TFile("./NTuples_ee"+finalState+"/"+samples_ee_UL2016postVFP_FR[i]+".root");
                ...
                TString histName_ee_prompt = samples_ee_UL2016postVFP_FR[i] + "_"+varName + "_ee_prompt";
                ...
                TString histName_ee_fake = samples_ee_UL2016postVFP_FR[i] + "_"+varName + "_ee_fake";
                ...
                //mumu
                std::cout << "MuMu channel " <<i<<":"+samples_mumu_UL2016postVFP_FR[i]<<std::endl;
                TFile * file_mumu = new TFile("./NTuples_mm"+finalState+"/"+samples_mumu_UL2016postVFP_FR[i]+".root");
                ...
                TString histName_mumu_prompt = samples_mumu_UL2016postVFP_FR[i] + "_"+varName+ "_mumu_prompt";
                ...
                TString histName_mumu_fake = samples_mumu_UL2016postVFP_FR[i] + "_"+varName+ "_mumu_fake";
    ...
    for (int i=0; i<9; ++i) { // run over samples
        ...
        TString histNameZ_ee_prompt = dySampleNames_UL2016postVFP[i] + "_"+varName+"_Z_ee_prompt";
        ...
        std::cout << dySampleNames_UL2016postVFP[i] << " -> DY Z = " << histZ_ee_prompt[i]->GetEntries() << " : " << histZ_ee_prompt[i]->GetSumOfWeights() << std::endl;
        
        TString histNameZ_ee_fake = dySampleNames_UL2016postVFP[i] + "_"+varName+"_Z_ee_fake";
        ...
        std::cout << dySampleNames_UL2016postVFP[i] << " -> DY Z = " << histZ_ee_fake[i]->GetEntries() << " : " << histZ_ee_fake[i]->GetSumOfWeights() << std::endl;
        ...
        TString histNameZ_mumu_prompt = dySampleNames_UL2016postVFP[i] + "_"+varName+"_Z_mumu_prompt";
        ...
        std::cout << dySampleNames_UL2016postVFP[i] << " -> DY Z = " << histZ_prompt[i]->GetEntries() << " : " << histZ_prompt[i]->GetSumOfWeights() << std::endl;
        histZ_prompt[i]->Add(histZ_prompt[i],histZ_ee_prompt[i]);
        
        TString histNameZ_mumu_fake = dySampleNames_UL2016postVFP[i] + "_"+varName+"_Z_mumu_fake";
        ...
        std::cout << dySampleNames_UL2016postVFP[i] << " -> DY Z = " << histZ_fake[i]->GetEntries() << " : " << histZ_fake[i]->GetSumOfWeights() << std::endl;
    ...
    std::cout << "end: DY stitching" << std::endl;
        ...
        leg->Draw();
        TLatex * cms = new TLatex(0.20,0.94,"CMS Preliminary L = 35.9 fb^{-1} at #sqrt{s} = 13 TeV, ll"+finalState);
