  ...
  for (int iF=0; iF<nTotalFiles; ++iF) {
    ...
    for (Long64_t iEntry=0; iEntry<numberOfEntries; iEntry++) { 
      ...
      for (unsigned int i=0; i<nfilters; ++i) {
        ...
        //Here: count Good (separation of leptons) ZMM Found
        if (isData)
            histWeightsDRLepsH->Fill(0.,1.);
        else
            histWeightsDRLepsH->Fill(0.,analysisTree.genweight);
        ...
        //Here: count Good (separation of leptons) Higgs Candidates found and extra lepton vetoes
        if (isData)
        ...
        if(applyTrigger)
        {
            ...
            //
            if ((isSingleMuon_1_TriggerFilterMatched == false) && (isSingleMuon_2_TriggerFilterMatched == false) && (isDoubleMuon_3_TriggerFilterMatched == false) && (isDoubleMuon_4_TriggerFilterMatched == false))
            //if ((isSingleMuon_1_TriggerFilterMatched == false))//test
                continue;
        }
