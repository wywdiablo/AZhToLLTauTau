...
void ProduceAZhDataCards_Syst_Btag(
                                 TString era = "UL2016postVFP",
                                 TString varName = "Mass_svc",
                                 TString UncerSuffix = "CMS_DeepFlavBtag_2018",
                                 TString Shift = "Down",
                                 TString TauIDName = "Btag",
                                 TString xtitle = "m^{c}_{ll#tau#tau} [GeV]",
                                 TString ytitle = "Events",
                                 bool blindData = true,
                                 TString ZfinalStates = "ll", //options: "ll", "ee", "mm"
                                 TString finalState = "tt",
                                 TString extraCuts = "*(nbtag_btagUp==0)",
