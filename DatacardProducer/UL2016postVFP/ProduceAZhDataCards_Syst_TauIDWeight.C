...
void ProduceAZhDataCards_Syst_TauIDWeight(
                                 TString era = "UL2016postVFP",
                                 TString varName = "Mass_svc",
                                 TString UncerSuffix = "CMS_eff_t_2018",
                                 TString Shift = "Down",
                                 TString TauIDName = "VSjetSF",
                                 ...
                                 TString CatName = "0btag")
{
	...
	double xsec[76] = { //in pico barn (fb)
        ...
        if(finalState == "em")
        {
            SRMCWeight = "IdSF_3*IdSF_4*prefiringweight*";
            Leg3ID = "electronIDWP90v2_3>0.5 && iso_3<0.15";
            Leg4ID = "muonLoose_4>0.5 && iso_4<0.15";
            if(TauIDName == "Prefire")
            {
                if(Shift == "Up")
                {
                    SRMCWeight = "IdSF_3*IdSF_4*prefiringweightUp*";
                }
                if(Shift == "Down")
                {
                    SRMCWeight = "IdSF_3*IdSF_4*prefiringweightDown*";
                }
            }
        }
        ...
        if(finalState == "et")
        {
            if(TauIDName == "VSjetSF")
            {
                if(Shift == "Up")
                {
                    SRMCWeight = "IdSF_3*tauVSjetSFUp_4*tauVSeSF_4*tauVSmuSF_4*prefiringweight*";
                }
                if(Shift == "Down")
                {
                    SRMCWeight = "IdSF_3*tauVSjetSFDown_4*tauVSeSF_4*tauVSmuSF_4*prefiringweight*";
                }
            }
            if(TauIDName == "VSeSF")
            {
                if(Shift == "Up")
                {
                    SRMCWeight = "IdSF_3*tauVSjetSF_4*tauVSeSFUp_4*tauVSmuSF_4*prefiringweight*";
                }
                if(Shift == "Down")
                {
                    SRMCWeight = "IdSF_3*tauVSjetSF_4*tauVSeSFDown_4*tauVSmuSF_4*prefiringweight*";
                }
            }
            if(TauIDName == "VSmuSF")
            {
                if(Shift == "Up")
                {
                    SRMCWeight = "IdSF_3*tauVSjetSF_4*tauVSeSF_4*tauVSmuSFUp_4*prefiringweight*";
                }
                if(Shift == "Down")
                {
                    SRMCWeight = "IdSF_3*tauVSjetSF_4*tauVSeSF_4*tauVSmuSFDown_4*prefiringweight*";
                }
            }
            if(TauIDName == "Prefire")
            {
                if(Shift == "Up")
                {
                    SRMCWeight = "IdSF_3*tauVSjetSF_4*tauVSeSF_4*tauVSmuSF_4*prefiringweightUp*";
                }
                if(Shift == "Down")
                {
                    SRMCWeight = "IdSF_3*tauVSjetSF_4*tauVSeSF_4*tauVSmuSF_4*prefiringweightDown*";
                }
            }
            Leg3ID = "electronIDWP90v2_3>0.5 && iso_3<0.15";
        ...
        if(finalState == "tt")
        {
            if(TauIDName == "VSjetSF")
            {
                if(Shift == "Up")
                {
                    SRMCWeight = "tauVSjetSFUp_3*tauVSeSF_3*tauVSmuSF_3*tauVSjetSFUp_4*tauVSeSF_4*tauVSmuSF_4*prefiringweight*";
                }
                if(Shift == "Down")
                {
                    SRMCWeight = "tauVSjetSFDown_3*tauVSeSF_3*tauVSmuSF_3*tauVSjetSFDown_4*tauVSeSF_4*tauVSmuSF_4*prefiringweight*";
                }
            }
            if(TauIDName == "VSeSF")
            {
                if(Shift == "Up")
                {
                    SRMCWeight = "tauVSjetSF_3*tauVSeSFUp_3*tauVSmuSF_3*tauVSjetSF_4*tauVSeSFUp_4*tauVSmuSF_4*prefiringweight*";
                }
                if(Shift == "Down")
                {
                    SRMCWeight = "tauVSjetSF_3*tauVSeSFDown_3*tauVSmuSF_3*tauVSjetSF_4*tauVSeSFDown_4*tauVSmuSF_4*prefiringweight*";
                }
            }
            if(TauIDName == "VSmuSF")
            {
                if(Shift == "Up")
                {
                    SRMCWeight = "tauVSjetSF_3*tauVSeSF_3*tauVSmuSFUp_3*tauVSjetSF_4*tauVSeSF_4*tauVSmuSFUp_4*prefiringweight*";
                }
                if(Shift == "Down")
                {
                    SRMCWeight = "tauVSjetSF_3*tauVSeSF_3*tauVSmuSFDown_3*tauVSjetSF_4*tauVSeSF_4*tauVSmuSFDown_4*prefiringweight*";
                }
            }
            if(TauIDName == "Prefire")
            {
                if(Shift == "Up")
                {
                    SRMCWeight = "tauVSjetSF_3*tauVSeSF_3*tauVSmuSF_3*tauVSjetSF_4*tauVSeSF_4*tauVSmuSF_4*prefiringweightUp*";
                }
                if(Shift == "Down")
                {
                    SRMCWeight = "tauVSjetSF_3*tauVSeSF_3*tauVSmuSF_3*tauVSjetSF_4*tauVSeSF_4*tauVSmuSF_4*prefiringweightDown*";
                }
            }
    ...
    //  adding up ZZ continue backgrounds
        ...
        TFile * file = new TFile("./Combineworkspace/shapes/produceArea/AZh_"+era+"_"+ZfinalStates+finalState+"_"+varName+"_"+TauIDName+Shift+"_"+CatName+".root","recreate");
    
        file->mkdir(ZfinalStates+finalState);
        file->cd(ZfinalStates+finalState);
        //TH1D * data_obs = (TH1D*)hist[0]->Clone("data_obs_"+UncerSuffix+Shift);
        TH1D * DY = (TH1D*)hist[1]->Clone("DY_"+UncerSuffix+Shift);
        TH1D * ggZZ = (TH1D*)hist[2]->Clone("ggZZ_"+UncerSuffix+Shift);
        TH1D * ZZ = (TH1D*)hist[8]->Clone("ZZ_"+UncerSuffix+Shift);
        TH1D * TTZ = (TH1D*)hist[10]->Clone("TTZ_"+UncerSuffix+Shift);
        TH1D * TTW = (TH1D*)hist[11]->Clone("TTW_"+UncerSuffix+Shift);
        TH1D * TT = (TH1D*)hist[12]->Clone("TT_"+UncerSuffix+Shift);
        TH1D * VVV = (TH1D*)hist[15]->Clone("VVV_"+UncerSuffix+Shift);
        TH1D * WZ = (TH1D*)hist[19]->Clone("WZ_"+UncerSuffix+Shift);
        TH1D * ggHtt = (TH1D*)hist[21]->Clone("ggHtt_"+UncerSuffix+Shift);
        TH1D * VBFHtt = (TH1D*)hist[22]->Clone("VBFHtt_"+UncerSuffix+Shift);
        TH1D * WHtt = (TH1D*)hist[23]->Clone("WHtt_"+UncerSuffix+Shift);
        TH1D * ZHtt = (TH1D*)hist[25]->Clone("ZHtt_"+UncerSuffix+Shift);
        TH1D * TTHtt = (TH1D*)hist[26]->Clone("TTHtt_"+UncerSuffix+Shift);
        TH1D * ggHWW = (TH1D*)hist[27]->Clone("ggHWW_"+UncerSuffix+Shift);
        TH1D * VBFHWW = (TH1D*)hist[28]->Clone("VBFHWW_"+UncerSuffix+Shift);
        TH1D * WHWW = (TH1D*)hist[29]->Clone("WHWW_"+UncerSuffix+Shift);
        TH1D * ZHWW = (TH1D*)hist[31]->Clone("ZHWW_"+UncerSuffix+Shift);
        TH1D * ggZHWW = (TH1D*)hist[32]->Clone("ggZHWW_"+UncerSuffix+Shift);
        TH1D * ggHZZ = (TH1D*)hist[33]->Clone("ggHZZ_"+UncerSuffix+Shift);

        TH1D * AZh225 = (TH1D*)hist[34]->Clone("AZh225_"+UncerSuffix+Shift);
        TH1D * AZh250 = (TH1D*)hist[35]->Clone("AZh250_"+UncerSuffix+Shift);
        TH1D * AZh275 = (TH1D*)hist[36]->Clone("AZh275_"+UncerSuffix+Shift);
        TH1D * AZh300 = (TH1D*)hist[37]->Clone("AZh300_"+UncerSuffix+Shift);
        TH1D * AZh325 = (TH1D*)hist[38]->Clone("AZh325_"+UncerSuffix+Shift);
        TH1D * AZh350 = (TH1D*)hist[39]->Clone("AZh350_"+UncerSuffix+Shift);
        TH1D * AZh375 = (TH1D*)hist[40]->Clone("AZh375_"+UncerSuffix+Shift);
        TH1D * AZh400 = (TH1D*)hist[41]->Clone("AZh400_"+UncerSuffix+Shift);
        TH1D * AZh450 = (TH1D*)hist[42]->Clone("AZh450_"+UncerSuffix+Shift);
        TH1D * AZh500 = (TH1D*)hist[43]->Clone("AZh500_"+UncerSuffix+Shift);
        TH1D * AZh600 = (TH1D*)hist[44]->Clone("AZh600_"+UncerSuffix+Shift);
        TH1D * AZh700 = (TH1D*)hist[45]->Clone("AZh700_"+UncerSuffix+Shift);
        TH1D * AZh750 = (TH1D*)hist[46]->Clone("AZh750_"+UncerSuffix+Shift);
        TH1D * AZh800 = (TH1D*)hist[47]->Clone("AZh800_"+UncerSuffix+Shift);
        TH1D * AZh900 = (TH1D*)hist[48]->Clone("AZh900_"+UncerSuffix+Shift);
        TH1D * AZh1000 = (TH1D*)hist[49]->Clone("AZh1000_"+UncerSuffix+Shift);
        TH1D * AZh1200 = (TH1D*)hist[50]->Clone("AZh1200_"+UncerSuffix+Shift);
        TH1D * AZh1400 = (TH1D*)hist[51]->Clone("AZh1400_"+UncerSuffix+Shift);
        TH1D * AZh1600 = (TH1D*)hist[52]->Clone("AZh1600_"+UncerSuffix+Shift);
        TH1D * AZh1800 = (TH1D*)hist[53]->Clone("AZh1800_"+UncerSuffix+Shift);
        TH1D * AZh2000 = (TH1D*)hist[54]->Clone("AZh2000_"+UncerSuffix+Shift);

        TH1D * BBAZh225 = (TH1D*)hist[55]->Clone("BBAZh225_"+UncerSuffix+Shift);
        TH1D * BBAZh250 = (TH1D*)hist[56]->Clone("BBAZh250_"+UncerSuffix+Shift);
        TH1D * BBAZh275 = (TH1D*)hist[57]->Clone("BBAZh275_"+UncerSuffix+Shift);
        TH1D * BBAZh300 = (TH1D*)hist[58]->Clone("BBAZh300_"+UncerSuffix+Shift);
        TH1D * BBAZh325 = (TH1D*)hist[59]->Clone("BBAZh325_"+UncerSuffix+Shift);
        TH1D * BBAZh350 = (TH1D*)hist[60]->Clone("BBAZh350_"+UncerSuffix+Shift);
        TH1D * BBAZh375 = (TH1D*)hist[61]->Clone("BBAZh375_"+UncerSuffix+Shift);
        TH1D * BBAZh400 = (TH1D*)hist[62]->Clone("BBAZh400_"+UncerSuffix+Shift);
        TH1D * BBAZh450 = (TH1D*)hist[63]->Clone("BBAZh450_"+UncerSuffix+Shift);
        TH1D * BBAZh500 = (TH1D*)hist[64]->Clone("BBAZh500_"+UncerSuffix+Shift);
        TH1D * BBAZh600 = (TH1D*)hist[65]->Clone("BBAZh600_"+UncerSuffix+Shift);
        TH1D * BBAZh700 = (TH1D*)hist[66]->Clone("BBAZh700_"+UncerSuffix+Shift);
        TH1D * BBAZh750 = (TH1D*)hist[67]->Clone("BBAZh750_"+UncerSuffix+Shift);
        TH1D * BBAZh800 = (TH1D*)hist[68]->Clone("BBAZh800_"+UncerSuffix+Shift);
        TH1D * BBAZh900 = (TH1D*)hist[69]->Clone("BBAZh900_"+UncerSuffix+Shift);
        TH1D * BBAZh1000 = (TH1D*)hist[70]->Clone("BBAZh1000_"+UncerSuffix+Shift);
        TH1D * BBAZh1200 = (TH1D*)hist[71]->Clone("BBAZh1200_"+UncerSuffix+Shift);
        TH1D * BBAZh1400 = (TH1D*)hist[72]->Clone("BBAZh1400_"+UncerSuffix+Shift);
        TH1D * BBAZh1600 = (TH1D*)hist[73]->Clone("BBAZh1600_"+UncerSuffix+Shift);
        TH1D * BBAZh1800 = (TH1D*)hist[74]->Clone("BBAZh1800_"+UncerSuffix+Shift);
        TH1D * BBAZh2000 = (TH1D*)hist[75]->Clone("BBAZh2000_"+UncerSuffix+Shift);
