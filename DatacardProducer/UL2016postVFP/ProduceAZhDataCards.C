                                 ...
                                 TString CatName = "inclusive")
{
	...
	double xsec[76] = { //in pico barn (fb)
        ...
        mumuCat1234Cuts = "fakeRateWeight_Z1*fakeRateWeight_Z2*fakeRateWeight_1*fakeRateWeight_2*(!(" + mumuLeg1ID + ") && !(" + mumuLeg2ID + ") && !(" + Leg3ID + ") && !(" + Leg4ID + "))";
            ...
            {
                //ee
                std::cout << "EE channel " <<i<<":"+samples_ee_UL2016postVFP_DC[i]<<std::endl;
                //TFile * file = new TFile("../NTuples/v7/"+samples[i]+".root");
                TFile * file_ee = new TFile("./NTuples_ee"+finalState+"/"+samples_ee_UL2016postVFP_DC[i]+".root");
                ...
                TString histName_ee = samples_ee_UL2016postVFP_DC[i] + "_"+varName + "_ee";
                ...
                //mumu
                std::cout << "MuMu channel " <<i<<":"+samples_mumu_UL2016postVFP_DC[i]<<std::endl;
                TFile * file_mumu = new TFile("./NTuples_mm"+finalState+"/"+samples_mumu_UL2016postVFP_DC[i]+".root");
                ...
                TString histName_mumu = samples_mumu_UL2016postVFP_DC[i] + "_"+varName+ "_mumu";
    ...
    TFile * file_data = new TFile("./NTuples_mm"+finalState+"/"+samples_mumu_UL2016postVFP_DC[0]+".root");
    TTree * tree_data = (TTree*)file_data->Get("SynTree");
    
    TString histName_dataCat1 = samples_mumu_UL2016postVFP_DC[0] + "_Cat1_"+varName;
    TString histName_dataCat2 = samples_mumu_UL2016postVFP_DC[0] + "_Cat2_"+varName;
    TString histName_dataCat3 = samples_mumu_UL2016postVFP_DC[0] + "_Cat3_"+varName;
    TString histName_dataCat4 = samples_mumu_UL2016postVFP_DC[0] + "_Cat4_"+varName;
    TString histName_dataCat12 = samples_mumu_UL2016postVFP_DC[0] + "_Cat12_"+varName;
    TString histName_dataCat13 = samples_mumu_UL2016postVFP_DC[0] + "_Cat13_"+varName;
    TString histName_dataCat14 = samples_mumu_UL2016postVFP_DC[0] + "_Cat14_"+varName;
    TString histName_dataCat23 = samples_mumu_UL2016postVFP_DC[0] + "_Cat23_"+varName;
    TString histName_dataCat24 = samples_mumu_UL2016postVFP_DC[0] + "_Cat24_"+varName;
    TString histName_dataCat34 = samples_mumu_UL2016postVFP_DC[0] + "_Cat34_"+varName;
    TString histName_dataCat123 = samples_mumu_UL2016postVFP_DC[0] + "_Cat123_"+varName;
    TString histName_dataCat124 = samples_mumu_UL2016postVFP_DC[0] + "_Cat124_"+varName;
    TString histName_dataCat234 = samples_mumu_UL2016postVFP_DC[0] + "_Cat234_"+varName;
    TString histName_dataCat1234 = samples_mumu_UL2016postVFP_DC[0] + "_Cat1234_"+varName;
    ...
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven Cat1 = " << hist_DR[0]->GetEntries() << " : " << hist_DR[0]->GetSumOfWeights() << std::endl;
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven Cat2 = " << hist_DR[1]->GetEntries() << " : " << hist_DR[1]->GetSumOfWeights() << std::endl;
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven Cat3 = " << hist_DR[2]->GetEntries() << " : " << hist_DR[2]->GetSumOfWeights() << std::endl;
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven Cat4 = " << hist_DR[3]->GetEntries() << " : " << hist_DR[3]->GetSumOfWeights() << std::endl;
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven Cat12 = " << hist_DR[4]->GetEntries() << " : " << hist_DR[4]->GetSumOfWeights() << std::endl;
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven Cat13 = " << hist_DR[5]->GetEntries() << " : " << hist_DR[5]->GetSumOfWeights() << std::endl;
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven Cat14 = " << hist_DR[6]->GetEntries() << " : " << hist_DR[6]->GetSumOfWeights() << std::endl;
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven Cat23 = " << hist_DR[7]->GetEntries() << " : " << hist_DR[7]->GetSumOfWeights() << std::endl;
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven Cat24 = " << hist_DR[8]->GetEntries() << " : " << hist_DR[8]->GetSumOfWeights() << std::endl;
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven Cat34 = " << hist_DR[9]->GetEntries() << " : " << hist_DR[9]->GetSumOfWeights() << std::endl;
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven Cat123 = " << hist_DR[10]->GetEntries() << " : " << hist_DR[10]->GetSumOfWeights() << std::endl;
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven Cat124 = " << hist_DR[11]->GetEntries() << " : " << hist_DR[11]->GetSumOfWeights() << std::endl;
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven Cat234 = " << hist_DR[12]->GetEntries() << " : " << hist_DR[12]->GetSumOfWeights() << std::endl;
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven Cat1234 = " << hist_DR[13]->GetEntries() << " : " << hist_DR[13]->GetSumOfWeights() << std::endl;
    ...
    TFile * file_data_ee = new TFile("./NTuples_ee"+finalState+"/"+samples_ee_UL2016postVFP_DC[0]+".root");
    TTree * tree_data_ee = (TTree*)file_data_ee->Get("SynTree");
    
    TString histName_dataCat1_ee = samples_ee_UL2016postVFP_DC[0] + "_Cat1_"+varName;
    TString histName_dataCat2_ee = samples_ee_UL2016postVFP_DC[0] + "_Cat2_"+varName;
    TString histName_dataCat3_ee = samples_ee_UL2016postVFP_DC[0] + "_Cat3_"+varName;
    TString histName_dataCat4_ee = samples_ee_UL2016postVFP_DC[0] + "_Cat4_"+varName;
    TString histName_dataCat12_ee = samples_ee_UL2016postVFP_DC[0] + "_Cat12_"+varName;
    TString histName_dataCat13_ee = samples_ee_UL2016postVFP_DC[0] + "_Cat13_"+varName;
    TString histName_dataCat14_ee = samples_ee_UL2016postVFP_DC[0] + "_Cat14_"+varName;
    TString histName_dataCat23_ee = samples_ee_UL2016postVFP_DC[0] + "_Cat23_"+varName;
    TString histName_dataCat24_ee = samples_ee_UL2016postVFP_DC[0] + "_Cat24_"+varName;
    TString histName_dataCat34_ee = samples_ee_UL2016postVFP_DC[0] + "_Cat34_"+varName;
    TString histName_dataCat123_ee = samples_ee_UL2016postVFP_DC[0] + "_Cat123_"+varName;
    TString histName_dataCat124_ee = samples_ee_UL2016postVFP_DC[0] + "_Cat124_"+varName;
    TString histName_dataCat234_ee = samples_ee_UL2016postVFP_DC[0] + "_Cat234_"+varName;
    TString histName_dataCat1234_ee = samples_ee_UL2016postVFP_DC[0] + "_Cat1234_"+varName;
    ...
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven Cat1 = " << hist_DR_ee[0]->GetEntries() << " : " << hist_DR_ee[0]->GetSumOfWeights() << std::endl;
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven Cat2 = " << hist_DR_ee[1]->GetEntries() << " : " << hist_DR_ee[1]->GetSumOfWeights() << std::endl;
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven Cat3 = " << hist_DR_ee[2]->GetEntries() << " : " << hist_DR_ee[2]->GetSumOfWeights() << std::endl;
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven Cat4 = " << hist_DR_ee[3]->GetEntries() << " : " << hist_DR_ee[3]->GetSumOfWeights() << std::endl;
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven Cat12 = " << hist_DR_ee[4]->GetEntries() << " : " << hist_DR_ee[4]->GetSumOfWeights() << std::endl;
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven Cat13 = " << hist_DR_ee[5]->GetEntries() << " : " << hist_DR_ee[5]->GetSumOfWeights() << std::endl;
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven Cat14 = " << hist_DR_ee[6]->GetEntries() << " : " << hist_DR_ee[6]->GetSumOfWeights() << std::endl;
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven Cat23 = " << hist_DR_ee[7]->GetEntries() << " : " << hist_DR_ee[7]->GetSumOfWeights() << std::endl;
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven Cat24 = " << hist_DR_ee[8]->GetEntries() << " : " << hist_DR_ee[8]->GetSumOfWeights() << std::endl;
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven Cat34 = " << hist_DR_ee[9]->GetEntries() << " : " << hist_DR_ee[9]->GetSumOfWeights() << std::endl;
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven Cat123 = " << hist_DR_ee[10]->GetEntries() << " : " << hist_DR_ee[10]->GetSumOfWeights() << std::endl;
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven Cat124 = " << hist_DR_ee[11]->GetEntries() << " : " << hist_DR_ee[11]->GetSumOfWeights() << std::endl;
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven Cat234 = " << hist_DR_ee[12]->GetEntries() << " : " << hist_DR_ee[12]->GetSumOfWeights() << std::endl;
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven Cat1234 = " << hist_DR_ee[13]->GetEntries() << " : " << hist_DR_ee[13]->GetSumOfWeights() << std::endl;
    ...
    TString histName_data_SS = samples_mumu_UL2016postVFP_DC[0] + "_SS_"+varName;
    hist_SS = new TH1D(histName_data_SS,"",nBins,bins);
    hist_SS->Sumw2();
    tree_data->Draw(varName+">>"+histName_data_SS, cutsRelaxed + HiggsSSCuts + extraCuts);
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven SS mumu (before Nor.) = " << hist_SS->GetEntries() << " : " << hist_SS->GetSumOfWeights() << std::endl;
    hist_SS->Scale(reducibleYield_mumu/hist_SS->GetSumOfWeights());

    TString histName_data_SS_ee = samples_ee_UL2016postVFP_DC[0] + "_SS_"+varName;
    ...
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven SS ee (before Nor.) = " << hist_SS_ee->GetEntries() << " : " << hist_SS_ee->GetSumOfWeights() << std::endl;
    ...
    TString histName_data_FR = samples_mumu_UL2016postVFP_DC[0] + "_FR_"+varName;
    hist_FR = new TH1D(histName_data_FR,"",nBins,bins);
    hist_FR->Sumw2();
    tree_data->Draw(varName+">>"+histName_data_FR, cuts_FR_mumu + HiggsSRCuts);
    std::cout << samples_mumu_UL2016postVFP_DC[0] << " -> Data Driven FR mumu (before Nor.) = " << hist_FR->GetEntries() << " : " << hist_FR->GetSumOfWeights() << std::endl;
    hist_FR->Scale(reducibleYield_mumu/hist_FR->GetSumOfWeights());

    TString histName_data_FR_ee = samples_ee_UL2016postVFP_DC[0] + "_FR_"+varName;
    hist_FR_ee = new TH1D(histName_data_FR_ee,"",nBins,bins);
    hist_FR_ee->Sumw2();
    tree_data_ee->Draw(varName+">>"+histName_data_FR_ee, cuts_FR_ee + HiggsSRCuts);
    std::cout << samples_ee_UL2016postVFP_DC[0] << " -> Data Driven FR ee (before Nor.) = " << hist_FR_ee->GetEntries() << " : " << hist_FR_ee->GetSumOfWeights() << std::endl;
