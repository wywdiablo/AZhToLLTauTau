...
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_Data.conf NTuples_SingleElectron_Run2016B-ver1 50
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_Data.conf NTuples_SingleElectron_Run2016B-ver2 50
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_Data.conf NTuples_SingleElectron_Run2016C 50
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_Data.conf NTuples_SingleElectron_Run2016D 50
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_Data.conf NTuples_SingleElectron_Run2016E 50
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_Data.conf NTuples_SingleElectron_Run2016F_preVFP 50
...
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_GluGluToContinToZZTo2e2mu 10
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_GluGluToContinToZZTo2e2tau 10
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_GluGluToContinToZZTo2mu2tau 10
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_GluGluToContinToZZTo4e_TuneCP5_13TeV-mcfm701-pythia8 10
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_GluGluToContinToZZTo4mu_TuneCP5_13TeV-mcfm701-pythia8 10
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_GluGluToContinToZZTo4tau 10
...
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_ttZJets_TuneCP5_13TeV_madgraphMLM_pythia8 40

./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_WWW 40
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_WWW-ext 40
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_WWZ 40
...
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_ZZZ-ext 40

./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8 40
...
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_GluGluHToTauTau_M125_TuneCP5_13TeV-powheg-pythia8 40
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_VBFHToTauTau_M125_TuneCP5_13TeV-powheg-pythia8 40
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_WminusHToTauTau_M125_TuneCP5_13TeV-powheg-pythia8 40
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_WplusHToTauTau_M125_TuneCP5_13TeV-powheg-pythia8 40
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_ZHToTauTau_M125_CP5_13TeV-powheg-pythia8_ext1 40
./HTC_submit_seq.sh SynchNtupleProducer_AZh_ee analysisMacro_AZh_eemt_MC.conf NTuples_ttHToTauTau_M125_TuneCP5_13TeV-powheg-pythia8 40
