...
for ieta in etas :
    ...
    for ipt in pts :
        ...
        for bin in bins :
            ...
            cb.AddObservations(['*'], ['JetEleFR'], ['2016'], ['lle'], categories['lle']) # adding observed data
            cb.AddProcesses(   ['*'], ['JetEleFR'], ['2016'], ['lle'], backgrounds, categories['lle'], False) # adding backgrounds
            cb.AddProcesses(   ['*'], ['JetEleFR'], ['2016'], ['lle'], signals, categories['lle'], True) # adding signals
            ...
            filepath = os.path.join("/nfs/dust/cms/user/ywen/AZh/workSpacev11/FRworkspace/shapes/pfmt_3_JetToEleFR_%s_%s_%s_%s.root")%(wps,ipt,ieta,bin)
