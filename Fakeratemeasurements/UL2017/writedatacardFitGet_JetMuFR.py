...
for ieta in etas :
    ...
    for ipt in pts :
        ...
        for bin in bins :
            ...
            cb.AddObservations(['*'], ['JetMuFR'], ['2017'], ['llm'], categories['llm']) # adding observed data
            cb.AddProcesses(   ['*'], ['JetMuFR'], ['2017'], ['llm'], backgrounds, categories['llm'], False) # adding backgrounds
            cb.AddProcesses(   ['*'], ['JetMuFR'], ['2017'], ['llm'], signals, categories['llm'], True) # adding signal
            ...
            filepath = os.path.join("/nfs/dust/cms/user/ywen/AZh/workSpacev10/FRworkspace/shapes/pfmt_3_JetToMuFR_%s_%s_%s_%s.root")%(wps,ipt,ieta,bin)
